...
def criterio(dato, campo=None):     #criterio es para ordenar la lista
    dic = {}
...
class Lista():
    ...
    def mayor_de_lista(self, campo):
        ...
        while(aux is not None):
            ...
            aux = aux.sig
        return mayor
    # def existe_siguiente(self):
    #         suguiente = self.__inicio.sig      #siguiente apunta al q le sigue (a,b,c) inicio seri "a" y siguiente es "b"
    #         if (suguiente is  None):
    #             return False
    #         else:
    #             return True
    # def existe_actual(self):
    #     actual = self.__inicio
    #     if (actual is  None):
    #         return False
    #     else:
    #         return True
    def insertar2_sin_ordenar(self, dato, campo=None):
        nodo = nodoLista()  #se crea un nodo
        nodo.info = dato    #se guarda lo q se ingresa
        nodo.sublista = Lista()     
